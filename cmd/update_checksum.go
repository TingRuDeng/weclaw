...
func verifyReleaseAssetChecksumFromSource(source releaseSource, version string, filename string, assetPath string) error {
	checksumFile, err := downloadReleaseAssetFromSource(source, version, "checksums.txt")
	if err != nil {
