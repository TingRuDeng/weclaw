...
func downloadFile(ctx context.Context, rawURL string) ([]byte, string, error) {
	...
	reqCtx, cancel := context.WithTimeout(ctx, remoteMediaDownloadTimeout)
	defer cancel()
...
func safeRemoteMediaDialContext(ctx context.Context, network string, address string) (net.Conn, error) {
